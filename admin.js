...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkOrderCompletion() {
        ...
        orders.forEach((order) => {
            if (order.Status == "Đã xử lí" && order.Display == true) {
    ...
    // setInterval(checkOrderCompletion, 60000);
    checkOrderCompletion();
});
document.querySelector(".form__submit-btn").addEventListener("click", addOneProduct);
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="4" class="order-detail-status">
                                                ...
                                                <select id="option-status" name="option-status">
