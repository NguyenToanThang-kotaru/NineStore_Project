// functions
{
    ...
    function uploadImg(inputElement) {
        ...
        if (fileSelected.length > 0) {
            ...
            fileReader.onload = function (fileLoaderEvent) // when the file are read
            {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    customerList.addEventListener("click", function (event) {
        if (event.target.closest(".customer__status")) // if the button clicked has the class "customer__status"
        {
